...
public class Screensaver extends javax.swing.JFrame implements Runnable{
    ...
    //comando que serve pra mexer o tamanho do preenchimendo da tela na parte da altura
    private int height = 800;

    //comando que serve pra mexer o tamanho do preenchimendo da tela na parte lateral
    ...
    public static void main(String[] args) {
        try {
            ...
            // percorre sobre as informações de aparência instaladas
            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {

                // Verifica se a aparência é Nimbus
                if ("Nimbus".equals(info.getName())) {

                    // Define a aparência Nimbus como o look and feel atual
                    javax.swing.UIManager.setLookAndFeel(info.getClassName());

                    // Sai do loop, pois a aparência Nimbus foi encontrada
                    break;
                }
            }
